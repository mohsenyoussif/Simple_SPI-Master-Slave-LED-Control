...
/*Initial state for MCU is floating input 
 ...
 #define PORTB_PIN4_DIR          1         /*SS pin :input piulled up for master */
 #define PORTB_PIN5_DIR          1         /*MOSI : master output slave input*/
 #define PORTB_PIN6_DIR          0         /*MISO : master input slave output*/
 #define PORTB_PIN7_DIR          1         /*SCK :outut*/
 ...
 #define PORTB_PIN4_INITIAL_VALUE         1     /*PUll up*/
